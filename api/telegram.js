 ...
 * Rota: POST https://theseventh.vercel.app/api/telegram
...
async function handleCalendario(chatId) {
  ...
  await sendMessage(chatId, `🗓️ *Calendário Editorial — Makro*\n\n` +
    ...
    `Acesse o Hub para ver em grade: https://theseventh.vercel.app/ (menu Editorial)`, { parse_mode: 'Markdown' });
}
