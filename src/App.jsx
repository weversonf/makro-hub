...
export default function App() {
  ...
  if (!user) {
    return (
      <div className="flex h-screen items-center justify-center p-4 bg-[var(--ax-canvas)]">
        <div className="ax-ambient" aria-hidden="true"><i /><i /></div>
        <div className="ax-card max-w-sm w-full relative z-10">
          <div className="ax-card__body p-8 flex flex-col items-center text-center gap-5">
            <img src="https://makroengenharia.com.br/wp-content/uploads/2023/03/logo-1.png" alt="Makro" height="32" className="h-8" />
            <div>
              <h2 className="font-bold text-xl text-[var(--ax-text-strong)]">Hub de Marketing</h2>
              <p className="text-xs text-[var(--ax-text-subtle)] mt-1">Gestão de Tarefas, Editorial e NPS Makro</p>
            </div>
            <button
              className="ax-btn ax-btn--primary w-full"
              onClick={signInWithGoogle}
            >
              <svg className="ax-btn__icon" viewBox="0 0 24 24" fill="currentColor">
